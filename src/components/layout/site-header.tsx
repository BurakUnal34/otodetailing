      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3.5 sm:gap-4 sm:px-6">
        ...
        >
          ...
          <span className="flex flex-col leading-none">
            <span className="text-[10px] font-bold uppercase tracking-[0.28em] text-brand-400">Oto</span>
            <span className="text-base font-bold tracking-wide text-white">Detailing</span>
          </span>
        </Link>
